...
<div class="row mb-5 blog-article">
	...
	<div class="col-sm-12 col-lg-6 col-md-6 d-flex flex-column ps-4 pe-0">
		<h2 class="blog-primary-font display-6 fst-italic text-dark-emphasis" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;">How to be more productive?</h2>
