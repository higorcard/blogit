...
<div class="row p-4 p-md-5 mb-5 rounded-3 bg-body-secondary align-items-center">
	<div class="col-lg-6 col-md-12 px-0">
		<h1 class="display-4 fst-italic text-body-emphasis blog-hero-h1">Find what you <br class="d-none d-lg-block">want here!</h1>
	</div>
...
<div class="row mb-5 blog-article">
	...
	<div class="col-sm-12 col-lg-6 col-md-6 d-flex flex-column ps-4 pe-0">
		<h2 class="display-6 fst-italic text-dark-emphasis" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;">How to be more productive?</h2>
		<p class="text-body-secondary">Last updated 3 mins ago · 3 comments</p>
		<p class="fs-4 blog-article-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer. This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer. This is a wider card with supporting text
		</p>
