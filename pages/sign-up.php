...
<body class="container d-flex align-items-center justify-content-center">
	<a class="position-absolute top-0 start-0 m-4 btn btn-sm btn-dark fs-5 d-flex align-items-center" href="pages/sign-in.php"><i class="bi bi-arrow-left fs-4 me-2"></i> Go home</a>
  ...
  <main class="form-signin w-100 m-auto">
    <form method="POST" action="int/register.php">
